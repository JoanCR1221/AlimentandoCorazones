...
namespace SIGAC.Infrastructure.Migrations
{
    ...
    [Migration("20260821003516_AddCheckTiempoComida")]
    partial class AddCheckTiempoComida
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SIGAC.Domain.Entities.AsistenciaComedor", b =>
                {
                    ...
                    b.ToTable("AsistenciasComedor", null, t =>
                        {
                            t.HasCheckConstraint("CK_AsistenciasComedor_TiempoComida", "[TiempoComida] IN ('Desayuno', 'Almuerzo', 'Cena')");
                        });
                });
