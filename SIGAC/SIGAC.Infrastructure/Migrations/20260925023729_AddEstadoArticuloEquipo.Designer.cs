...
namespace SIGAC.Infrastructure.Migrations
{
    ...
    [Migration("20260925023729_AddEstadoArticuloEquipo")]
    partial class AddEstadoArticuloEquipo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SIGAC.Domain.Entities.Articulo", b =>
                {
                    ...
                    b.ToTable("Articulos", null, t =>
                        {
                            t.HasCheckConstraint("CK_Articulos_Estado_Coherente", "([Categoria] = 'Equipo' AND [Estado] IN ('Nuevo', 'En buen estado', 'Dañado')) OR ([Categoria] <> 'Equipo' AND [Estado] IS NULL)");
                    ...
                    b.ToTable("DetallesDonacionEspecie", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_DetallesDonacionEspecie_Estado_Coherente", "([Categoria] = 'Equipo' AND [Estado] IN ('Nuevo', 'En buen estado', 'Dañado')) OR ([Categoria] <> 'Equipo' AND [Estado] IS NULL)");
                        });
                });
